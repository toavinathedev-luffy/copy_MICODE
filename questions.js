export const Questions = [
  ...
  {
    question:
      "Quelle méthode transforme une chaine de caractère en nombre entier ?",
  ...
  {
    question:
      "Quelle est la valeur de 'null' lorsq'elle est convertie en nombre  ?",
    answers: ["0", "1", "undefined", "null"],
    correct: "0",
  },
  {
    question: "Comment accéder au 1er élement d'un tableau appellé 'myArray' ?",
